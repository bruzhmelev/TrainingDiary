...
pug_html = pug_html + "\u003Clabel\u003E";
;pug_debug_line = 8;pug_debug_filename = "blocks\u002FexerciseAddForm\u002FexerciseAddForm.pug";
pug_html = pug_html + "Название переменного параметра в тренировке (вес, высота запрыгивания). Пример \"Штанга, кг\", \"Утяжелители для бега, кг\"";
