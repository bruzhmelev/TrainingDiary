...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function trainingProgress_tmpl(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"blocks\u002FtrainingProgress\u002FtrainingProgress.pug":"div.panel-head\r\n    h3 Результаты текущей тренировки\r\ntable\r\n    tr\r\n        th Время выполнения\r\n        th Упражнение\r\n        th Результат выполнения\r\n        th Переменный параметр\r\n        each trainSet in trainSets\r\n            tr.training-progress__item-container\r\n                td.training-progress__train-set-time=trainSet.time.toLocaleString(\"ru\", options)\r\n                td.training-progress__train-set-name=trainSet.exercise.name\r\n                td.training-progress__train-set-result=trainSet.result\r\n                td.training-progress__train-set-variable-parameter-value=trainSet.exercise.variableParameterName + \": \" \r\n                    if trainSet.variableParameterValue\r\n                        span=trainSet.variableParameterValue\r\n                    else\r\n                        span нет"};
...
;pug_debug_line = 2;pug_debug_filename = "blocks\u002FtrainingProgress\u002FtrainingProgress.pug";
pug_html = pug_html + "Результаты текущей тренировки\u003C\u002Fh3\u003E\u003C\u002Fdiv\u003E";
...
;pug_debug_line = 14;pug_debug_filename = "blocks\u002FtrainingProgress\u002FtrainingProgress.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = trainSet.exercise.variableParameterName + ": ") ? "" : pug_interp));
;pug_debug_line = 15;pug_debug_filename = "blocks\u002FtrainingProgress\u002FtrainingProgress.pug";
if (trainSet.variableParameterValue) {
;pug_debug_line = 16;pug_debug_filename = "blocks\u002FtrainingProgress\u002FtrainingProgress.pug";
pug_html = pug_html + "\u003Cspan\u003E";
;pug_debug_line = 16;pug_debug_filename = "blocks\u002FtrainingProgress\u002FtrainingProgress.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = trainSet.variableParameterValue) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
else {
;pug_debug_line = 18;pug_debug_filename = "blocks\u002FtrainingProgress\u002FtrainingProgress.pug";
pug_html = pug_html + "\u003Cspan\u003E";
;pug_debug_line = 18;pug_debug_filename = "blocks\u002FtrainingProgress\u002FtrainingProgress.pug";
